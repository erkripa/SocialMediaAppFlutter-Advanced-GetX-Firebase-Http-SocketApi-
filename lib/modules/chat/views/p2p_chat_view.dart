...
import 'package:social_media_app/modules/chat/components/chat_bubble_widget.dart';
import 'package:social_media_app/modules/chat/components/chat_reply_to_box.dart';
...
class P2PChatView extends StatelessWidget {
        ...
        child: GetBuilder<P2PChatController>(
          builder: (logic) {
            if (!logic.initialized) {
              return const Center(child: AyushCircularProgressIndicator());
            }
  ...
  AyushAppBar _buildAppBar(BuildContext context, P2PChatController logic) {
    return AyushAppBar(
  ...
  Widget _buildBody(BuildContext context, P2PChatController logic) {
    if (logic.isLoading && logic.chatMessages.isEmpty) {
      return Center(
        ...
        child: const AyushCircularProgressIndicator(),
      ));
    }
